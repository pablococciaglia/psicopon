export const text = {
      ...
      professionals: [
        {
          ...
          photo: 'https://res.cloudinary.com/ddbrs5z8v/image/upload/v1770765082/lic-1_vrdcrk.jpg',
          linkedin:
        ...
        },
        {
          ...
          photo: 'https://res.cloudinary.com/ddbrs5z8v/image/upload/v1770765083/lic-3_imarqc.jpg',
          linkedin:
        ...
        },
        {
          ...
          photo: 'https://res.cloudinary.com/ddbrs5z8v/image/upload/v1770765083/lic-4_mnpg33.jpg',
          linkedin:
        ...
        },
        {
          ...
          photo: 'https://res.cloudinary.com/ddbrs5z8v/image/upload/v1770765082/lic-2_zpcjsf.jpg',
        },
      ],
    },
    stuff: {
  ...
  attention: {
    ...
    cards: [
      ...
      {
        photo:
          'https://res.cloudinary.com/ddbrs5z8v/image/upload/v1770765080/attention-kids_ai8ah0.jpg',
        title: 'Niños',
      ...
      {
        photo:
          'https://res.cloudinary.com/ddbrs5z8v/image/upload/v1770765081/attention-teens_tkecfe.jpg',
        title: 'Adolescentes',
      ...
      {
        photo:
          'https://res.cloudinary.com/ddbrs5z8v/image/upload/v1770765079/attention-adults_bsknfx.jpg',
        title: 'Adultos',
      ...
      {
        photo:
          'https://res.cloudinary.com/ddbrs5z8v/image/upload/v1770765080/attention-couples_yag40x.jpg',
        title: 'Pareja',
      ...
      {
        photo:
          'https://res.cloudinary.com/ddbrs5z8v/image/upload/v1770765080/attention-orientation_hjg4h0.jpg',
      ...
      {
        photo:
          'https://res.cloudinary.com/ddbrs5z8v/image/upload/v1770765079/attention-diag_jdtivx.jpg',
  ...
  news: {
    ...
    cards: [
      {
        photo: 'https://res.cloudinary.com/ddbrs5z8v/image/upload/v1770765079/news-7_vdmmoq.jpg',
        title:
      ...
      {
        photo: 'https://res.cloudinary.com/ddbrs5z8v/image/upload/v1770765083/news-1_pxjg70.jpg',
        ...
        source: 'https://www.pagina12.com.ar/10127-de-que-hablamos-cuando-hablamos-de-amor',
      },
      {
        photo: 'https://res.cloudinary.com/ddbrs5z8v/image/upload/v1770765079/news-2_wub4ci.jpg',
      ...
      {
        photo: 'https://res.cloudinary.com/ddbrs5z8v/image/upload/v1770765079/news-3_okunl2.jpg',
        ...
        fullText: [
          ['h3', '¿Por qué solemos elegir el mismo tipo de pareja sentimental?'],
          [
            'b',
          ...
          ['h3', '4. Tener confianza en ti mismo/a y valorarse (conocerse a uno mismo)'],
        ...
        source: 'https://psicologiaymente.com/pareja/eliges-siempre-mismo-tipo-de-pareja',
      },
      {
        photo: 'https://res.cloudinary.com/ddbrs5z8v/image/upload/v1770765079/news-4_iabghm.jpg',
        ...
        fullText: [
          ...
          ['h2', 'Las 30 señales de que tu pareja puede estar maltratándote psicológicamente'],
          ...
          ['li', 'Malestar físico'],
          ['li', 'Baja autoestima'],
          ['li', 'Pérdida de relaciones sociales llevando en muchas ocasiones al aislamiento'],
          ...
          ['h2', 'Tomando conciencia para poder abandonar las dinámicas de maltrato'],
          [
            'b',
        ...
        source: 'https://psicologiaymente.com/coach/salir-zona-de-confort-claves',
      },
      {
        photo: 'https://res.cloudinary.com/ddbrs5z8v/image/upload/v1770765079/news-5_qkmcgu.jpg',
        ...
        fullText: [
          ...
          ['h3', '5. Conocerás a gente nueva y vivirás nuevas experiencias gratificantes'],
          ...
          ['h3', '2. Piensa en tu estilo de hacer las cosas… y actúa en el sentido opuesto'],
      ...
      {
        photo: 'https://res.cloudinary.com/ddbrs5z8v/image/upload/v1770765079/news-6_kryijm.jpg',
        ...
        source: 'https://psicologiaparaninos.com/2015/11/en-tu-familia-practican-la-doble-moral/',
      },
    ],
  },
  questions: {
    ...
    faq: [
      ...
      {
        question: '¿La terapia online es efectiva?',
        answer:
          'Sí. La terapia online ha demostrado ser eficaz para la mayoría de las problemáticas. Permite flexibilidad y acceso desde cualquier lugar, manteniendo la misma calidad y confidencialidad que la modalidad presencial.',
      },
      {
        question: '¿La terapia es confidencial?',
        answer:
          'Sí. Todo lo que se comparte en sesión está protegido por el secreto profesional y la normativa de protección de datos. La confidencialidad es un pilar fundamental del proceso terapéutico.',
      },
      {
